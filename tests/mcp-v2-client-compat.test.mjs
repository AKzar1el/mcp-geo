...
const EXPECTED_TOOLS = ['check_visibility','compare_competitors','generate_prompts','get_citations','get_content_gaps','get_visibility_history','list_brands','list_prompts','refresh_brand','set_prompts','track_brand','update_brand'];
