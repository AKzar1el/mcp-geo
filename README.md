...
| `visibility.content_gaps` | Prioritized Claude-Haiku-generated content recommendations targeting your actual losing prompts. | `brand_id`, optional `max_recommendations` (1-10) |
